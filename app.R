...
ui <- page_navbar(
  ...
  nav_panel("Year to Date", plotlyOutput("ytd", height = 400, width = 750)),
  nav_panel("Trend (Month-to-Month)", plotlyOutput("mtm", height = 400, width = 750)),
  nav_panel("12-Month Rolling Sum", plotlyOutput("rs", height = 400, width = 750)),
